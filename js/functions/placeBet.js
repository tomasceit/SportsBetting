...
function placeBetHome(e) {
    ...
    odds.innerHTML =    `<div class="d-flex flex-column">
                            <div class="d-flex">
                                <h5 class="mr-7">HomeWin | 2</h5>
                                <button type="button" class="close" onclick="removeBet()" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <strong class="ml-5"> ${odds1} </strong>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-2">
                            <button class="btn btn-dark" type="submit" onclick= style="width: 70px">APOSTAR</button>
                        </div>
                        <hr />`;
...
function placeBetDraw(e) {
    ...
    odds.innerHTML =    `<div class="d-flex flex-column">
                            <div class="d-flex">
                                <h5 class="mr-7 ml-1">Draw | x</h5>
                                <button type="button" class="close ml-4" onclick="removeBet()" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="d-flex mb-4">
