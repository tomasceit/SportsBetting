...
// Funcion que elimina las apuestas colocadas
...
function showBets() {
    if (betGames.length === 0) {
        elem = document.getElementById("card-body");
        elem.innerHTML = `<p class="text-center">Para realizar otras apuestas, clickea en las probabilidades</p>`;
        return;
    }
    // Creo el 'remove all'
    ...
    betGames.forEach(game => {
        ...
        ryz.innerHTML = `<div class="d-flex flex-column">
                                <div class="d-flex justify-content-between">
                                    <h5>${game.whoWins}</h5>
                                    <button type="button" class="close pb-2" onclick="" data-dismiss="modal" aria-label="Close">
    ...
    ryz.innerHTML = `<div class="d-flex justify-content-between align-items-center">
                        <span> CANTIDAD: </span>
                        <input id="betAmount" type="number" placeholder="Bet" oninput="bet(${totalOdds},this)" class="text-center" style="width: 110px">
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <button class="btn btn-green" type="submit" onclick="apostar()" style="width: 120px">APOSTAR</button>
                    </div>
                    <hr />`;
    padre.appendChild(ryz);
}